...
async function _runSubjectParameterSync(onlyMissing: boolean): Promise<{ sectionsCount: number; parametersCount: number; synonymsCount: number }> {
  ...
  const STATIC_SECTIONS = [
    ...
    ...(OS_CLIENT_TYPE_ID ? [
      ...
      { clientTypeId: OS_CLIENT_TYPE_ID, name: "API a Kalkulačka", code: "os_web_api", folderCategory: "povinne", sortOrder: 10, isPanel: true, gridColumns: 2 },
      { clientTypeId: OS_CLIENT_TYPE_ID, name: "Reklamné systémy a Výkon", code: "os_web_ads", folderCategory: "povinne", sortOrder: 11, isPanel: true, gridColumns: 2 },
  ...
  const parentCodes: Record<string, string> = {
    ...
    os_web_api: "os_povinne", os_web_ads: "os_povinne",
  ...
  const FIELDS: FieldSeed[] = [
    ...
    ...(OS_CLIENT_TYPE_ID ? [
      ...
      // Row 2: nazov_webu(50) + nadriadeny_subjekt_uid(50, short_text)
      // Row 3: web_uid(50) + url_adresa(50)
      // Row 4: typ_prevadzky(50, enum) + datum_spustenia_webu(50, date)
      // ============================================================
      ...
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_subjekt", "nadriadeny_subjekt_uid", "UID materskej spoločnosti", "short_text", 720, 2, 50, { shortLabel: "UID materskej", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      ...
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_subjekt", "typ_prevadzky", "Typ prevádzky", "jedna_moznost", 750, 4, 50, { shortLabel: "Typ prevádzky", options: ["Vlastný web", "Affiliate partner", "Microsite"], visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_subjekt", "datum_spustenia_webu", "Dátum spustenia", "date", 760, 4, 50, { shortLabel: "Dátum spustenia", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),

      // ============================================================
      // OS: API a Kalkulačka (os_web_api) – Web only
      // Row 0: api_kalkulacka_id(50) + status_api(50, enum)
      // Row 1: web_api_key(100)
      // ============================================================
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_api", "api_kalkulacka_id", "ID kalkulačky / API kľúč prepojenia", "short_text", 10, 0, 50, { shortLabel: "ID kalkulačky", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_api", "status_api", "Stav API", "jedna_moznost", 20, 0, 50, { shortLabel: "Stav API", options: ["Aktívne", "Testovanie", "Odpojené"], visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_api", "web_api_key", "API kľúč", "short_text", 30, 1, 100, { shortLabel: "API kľúč", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),

      // ============================================================
      // OS: Reklamné systémy a Výkon (os_web_ads) – Web only
      // Row 0: zdroj_prijmu_hlavny(50) + ad_account_id(50)
      // Row 1: pixel_tracking_id(50) + konverzny_pomer_ciel(50)
      // ============================================================
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_ads", "zdroj_prijmu_hlavny", "Hlavný zdroj príjmu", "short_text", 10, 0, 50, { shortLabel: "Zdroj príjmu", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_ads", "ad_account_id", "ID reklamného účtu", "short_text", 20, 0, 50, { shortLabel: "Ad Account ID", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_ads", "pixel_tracking_id", "Pixel / Tracking ID", "short_text", 30, 1, 50, { shortLabel: "Pixel ID", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
      f(OS_CLIENT_TYPE_ID, "os_povinne", "os_web_ads", "konverzny_pomer_ciel", "Cieľ konverzného pomeru", "short_text", 40, 1, 50, { shortLabel: "Konv. pomer cieľ", visibilityRule: { dependsOn: "specifikacia_os", value: "Web / Digitálne aktívum" } }),
    ] : []),
  ];
