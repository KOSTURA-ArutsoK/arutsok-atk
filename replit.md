...
- **Drag & Drop Reordering**: Native HTML5 drag&drop with GripVertical handles for contract statuses, contract inventories, and client types. Reorder endpoints: `PUT /api/contract-statuses/reorder`, `PUT /api/contract-inventories/reorder`, `PUT /api/client-types/reorder`.
