...
- **Global Subject Relations System**: Universal cross-entity linking via `subject_relations` with 32 `relation_role_types`, temporal validity, and context-aware relations.
