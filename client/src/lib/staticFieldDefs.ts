...
export const FO_FIELDS: StaticField[] = [
  ...
  { id: 12, clientTypeId: 1, sectionId: FO_SECTION_POVINNE, panelId: FO_PANEL_OSOBNE, fieldKey: "titul_za", label: "Titul za menom", fieldType: "short_text", isRequired: false, isHidden: false, options: [], defaultValue: null, visibilityRule: null, unit: null, decimalPlaces: 2, fieldCategory: "povinne", sortOrder: 4, rowNumber: 1, widthPercent: 12 },
