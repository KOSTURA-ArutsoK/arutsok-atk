...
export const FO_FIELDS: StaticField[] = [
  ...
  { id: 106, clientTypeId: 1, sectionId: FO_SECTION_POVINNE, panelId: FO_PANEL_OSOBNE, fieldKey: "druhe_meno", label: "Druhé meno/priezvisko", fieldType: "TEXT", isRequired: false, isHidden: false, options: [], defaultValue: null, visibilityRule: null, unit: null, decimalPlaces: 2, fieldCategory: "povinne", sortOrder: 2, rowNumber: 1, widthPercent: 20 },
