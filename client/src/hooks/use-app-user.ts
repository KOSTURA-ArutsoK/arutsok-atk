...
export function useSetActiveContext() {
  ...
  return useMutation({
    mutationFn: async (data: { activeCompanyId?: number | null; activeStateId?: number; activeDivisionId?: number | null; activeSubjectId?: number | null; activeKtoCompanyId?: number | null }) => {
