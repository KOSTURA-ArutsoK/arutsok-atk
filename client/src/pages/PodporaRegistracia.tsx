...
import { Phone, Save, Info, Building2, Globe, Lock, Shield, Settings as SettingsIcon, Database } from "lucide-react";
...
export default function PodporaRegistracia() {
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold" data-testid="text-page-title">Podpora a registracia</h1>
      </div>
