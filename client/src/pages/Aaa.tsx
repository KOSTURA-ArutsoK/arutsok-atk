      ...
      {SUBJECT_TYPE_OPTS.map((opt, idx) => {
        ...
        return (
          <button
            ...
            title={opt.label}
            className={`relative z-10 flex-1 flex items-center justify-center gap-1.5 px-2 py-3 text-xs font-medium rounded transition-all duration-150 outline-none focus-visible:ring-2 focus-visible:ring-primary/50 ${isActive ? "text-foreground" : "text-muted-foreground hover:text-foreground/80"}`}
