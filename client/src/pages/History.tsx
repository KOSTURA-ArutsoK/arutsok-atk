...
const FILTER_COLUMNS: SmartColumnDef[] = [
  ...
  { key: "entityName", label: "Entita", type: "text" },
  { key: "processingTimeSec", label: "Cas spracovania", type: "number" },
];
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between gap-2 flex-wrap">
            ...
            <Button variant="ghost" size="sm" onClick={() => { resetFilters(); tableFilter.clearAll(); }} data-testid="button-reset-filters">
              Zrusit filtre
            </Button>
          </div>
